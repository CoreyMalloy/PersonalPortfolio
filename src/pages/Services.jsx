...
const Cards = ({ services }) => {
  ...
  return (
    <div style={{display:'flex', flexDirection: 'column', height: '100vh', backgroundColor: '#00ABE4'}}>
      <h2 style={{display: 'flex', justifyContent: 'center', fontSize: '5rem', fontWeight: '400', color: '#E9F1FA', width: '100%'}}>{subheading}</h2>
      <div style={{display:'flex', justifyContent: 'space-evenly'}}>
        {service.map((item) => (
          <div style={{ margin: 'auto', display: 'flex', flexDirection:'column',
            ...
            <h3 style={{fontSize: '3rem', fontWeight: '200', borderBottom: '2px solid #00ABE4'}}>{item.title}</h3>
